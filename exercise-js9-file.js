...
// time.start(); // شروع می‌کنه

// setTimeout(() => {
//   time.pausez(); // بعد از 3 ثانیه متوقف میشه
//   console.log("paused at:", time.getTime());

//   setTimeout(() => {
//     time.start(); // دوباره ادامه میده
//     console.log("resumed");
...
// Array.prototype.mmad =function(func){❤️❤️❤️❤️
//   let result = [];
